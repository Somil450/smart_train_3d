...
class MqttService {
  ...
  AppMqttConnectionState get connectionState => _state;
  ...
  void _startSimulation() {
    _setState(AppMqttConnectionState.connected); // green badge = "sim connected"
    final rng = Random();
    int tick = 0;
  ...
  void _setState(AppMqttConnectionState s) {
    _state = s;
  }
}
